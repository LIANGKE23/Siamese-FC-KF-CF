...
if __name__ == '__main__':
    ...
    ## Data Path
    root_dir = os.path.join('E:\PSUThirdSemester\CSE586ComputerVision\Term-Project1\Pythonversion\data', 'VOT2017')
    e = ExperimentVOT(root_dir,version = 2017,result_dir='results_KF_CF', report_dir='reports_KF_CF')
