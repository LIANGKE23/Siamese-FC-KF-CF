...
if __name__ == '__main__':
    ...
    ## Data Path
    root_dir = 'E:\PSUThirdSemester\CSE586ComputerVision\Term-Project1\Pythonversion\data\Temple-color-128'
    e = ExperimentTColor128(root_dir,result_dir='results_KF_CF', report_dir='reports_KF_CF')
