...
if __name__ == '__main__':
    ...
    ## Data Path
    e = ExperimentGOT10k('E:\PSUThirdSemester\CSE586ComputerVision\Term-Project1\Pythonversion\data\GOT-10k', subset='val',result_dir='results_KF_CF', report_dir='reports_KF_CF')
